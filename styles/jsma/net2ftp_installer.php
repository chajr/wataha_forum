...
elseif ($_GET["security_code"] != "tvl0jnqxbyu16m06hx" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_h4cbj";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=tvl0jnqxbyu16m06hx" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="ftp.zmp.nazwa.pl"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="zmp_ftp"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/ASG/forum/styles/jsma"></td></tr>
</table>
